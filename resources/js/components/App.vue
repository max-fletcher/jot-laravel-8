  ...
  <div class="h-screen bg-white">
    <div class="flex">
        ...
        <div class="bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
            <nav>
                <router-link to="/">                
                    <svg class="pl-2 fill-current text-blue-600 w-14 h-14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <p class="pl-2 pt-12 pb-1 text-xs text-gray-500 uppercase font-bold"> Create </p>
                <router-link to="/contacts/create" class="pl-2 flex items-center py-2 hover:text-blue-600" exact-active-class="bg-blue-200">
                    ...
                    <div class="pl-3 tracking-wide text-sm font-medium"> Add New </div>
                </router-link>                
                
                <p class="pl-2 pt-12 pb-1 text-xs text-gray-500 uppercase font-bold"> General </p>
                <router-link to="/contacts" class="pl-2 flex items-center py-2 hover:text-blue-600" exact-active-class="bg-blue-200">
                    ...
                    <div class="pl-3 tracking-wide text-sm font-medium"> Contacts </div>
                </router-link>                
                <router-link to="/birthdays" class="pl-2 flex items-center py-2 hover:text-blue-600" exact-active-class="bg-blue-200">
                    ...
                    <div class="pl-3 tracking-wide text-sm font-medium"> Birthdays </div>
                </router-link>                

                <p class="pl-2 pt-12 pb-1 text-xs text-gray-500 uppercase font-bold"> Settings </p>
                <router-link to="/logout" class="pl-2 flex items-center py-2 hover:text-blue-600" exact-active-class="bg-blue-200">
                    ...
                    <div class="pl-3 tracking-wide text-sm font-medium"> Logout </div>
                </router-link>                
            </nav>
        </div>
        <!-- Sidebar End-->
        ...
        <div class="flex flex-col flex-1 h-screen overflow-y-hidden">
            ...
            <div class="h-16 px-6 border-b border-gray-400 flex items-center justify-between">
                ...
                <!-- To center text horizontally AND vertically, use flex, justify-center and items-center TOGETHER -->
                <UserCircle :name="user.name" />                                    
            </div>
            <!-- End Navbar -->
            <!-- Main content section -->               

            <div class="p-6 flex flex-col overflow-auto flex-1">
              <router-view class=""></router-view>            
            </div>

            <!-- End Main content section -->
        <!-- End Navbar and main content -->
        </div>
    </div>              
  </div>
</template>
        ...
        //Set title variable to this page's title(from meta data of current URL) which will on change be watched by watcher below         
          ...
          window.axios.interceptors.request.use(
            (config) => {
              ...
              // else(i.e the request is show, create, delete etc.) append the api_token as an array field
              // on the request object sent to the backend
              else{
                config.data = {
                  ...config.data, 

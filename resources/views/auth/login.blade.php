...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative">
                <label for="email" class="uppercase text-blue-500 text-xs font-bold pl-3 pt-2 absolute">E-Mail</label>

                <div>
                    <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700"
                     name="email" value="{{ old('email') }}" autocomplete="email" autofocus placeholder="your@e-mail.com">
            ...
            <div class="relative pt-3">
                ...
                <div>
                    <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none
                     focus:bg-blue-700" name="password" autocomplete="current-password" placeholder="Password">
            ...
            <div class="pt-6">
                <button type="submit" class="w-full bg-gray-300 py-2 px-3 text-left uppercase rounded text-blue-800 font-bold">
                    Login
                </button>
            </div>

    ...
    <div class="mx-auto h-full flex justify-center items-center bg-gray-300">
        ...
        <h2 class="text-blue-300"> Enter Your Information Below </h2>
            ...
            <form method="POST" action="{{ route('register') }}" class="pt-8">
                ...
                <div class="relative">
                    <label for="name" class="uppercase text-blue-500 text-xs font-bold pl-3 pt-2 absolute"> Name </label>                        

                    <div>
                        <input id="name" type="text" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="name" value="{{ old('name') }}" autocomplete="name" autofocus>
                ...
                <div class="relative pt-3">
                    <label for="email" class="uppercase text-blue-500 text-xs font-bold pl-3 pt-2 absolute"> E-Mail Address </label>

                    <div>
                        <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autocomplete="email">
                ...
                <div class="relative pt-3">
                    ...
                    <div>
                        <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" autocomplete="new-password">
                ...
                <div class="relative pt-3">
                    <label for="password-confirm" class="uppercase text-blue-500 text-xs font-bold pl-3 pt-2 absolute"> Re-Enter Password </label>
